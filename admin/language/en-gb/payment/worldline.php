...
$_['text_webhook_credential_alert']				= 'To retrieve the webhooks credentials, follow these steps:<br />1) Login to the Back Office<br />2) Go to Configuration > Technical information > Ingenico Direct settings > Webhooks Configuration<br />3) Click on "GENERATE WEBHOOKS API KEY"<br />4) Copy & Paste the WebhooksKeySecret immediately<br />5) In "Endpoints URLs", paste the Webhook URL of your store<br />5) Click on "SAVE" to confirm your settings';
