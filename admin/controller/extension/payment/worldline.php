...
class ControllerExtensionPaymentWorldline extends Controller {
	...
	public function transaction() {
		...
		$data['sort_order_id'] = $this->url->link('extension/payment/worldline/transaction', 'token=' . $this->session->data['token'] . '&sort=wo.order_id' . $url, true);
		$data['sort_transaction_id'] = $this->url->link('extension/payment/worldline/transaction', 'token=' . $this->session->data['token'] . '&sort=wo.transaction_id' . $url, true);
		$data['sort_transaction_status'] = $this->url->link('extension/payment/worldline/transaction', 'token=' . $this->session->data['token'] . '&sort=wo.transaction_status' . $url, true);
		$data['sort_payment_product'] = $this->url->link('extension/payment/worldline/transaction', 'token=' . $this->session->data['token'] . '&sort=wo.payment_product' . $url, true);
		...
		$pagination->url = $this->url->link('extension/payment/worldline/transaction', 'token=' . $this->session->data['token'] . $url . '&page={page}', true);
